...
export default function ProjectsShowcase({ items = [] }) {
      ...
      {activeItem && (
        ...
        `}
          ...
          <div
            ...
            className={`absolute left-1/2 z-10 w-[60px] h-[60px] grid place-items-center bg-green-400 border-[5px] border-green-700
                [bg-shadow:0_0_8px_theme(colors.green.400)] rounded-full cursor-pointer transition-all ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          ${
            isMoving
